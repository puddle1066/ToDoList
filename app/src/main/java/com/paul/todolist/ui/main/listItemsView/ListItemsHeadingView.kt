...
fun ListItemsHeadingView() {
    ...
    ToolboxTheme {
        Scaffold(
            topBar = { ListItemsTopBar(scope,scaffoldState) },
...
@Composable
fun ListItemsTopBar(scope : CoroutineScope, scaffoldState : ScaffoldState) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .height(50.dp)
        ...
        Text(
            ...
            text = LocalContext.current.resources.getString(R.string.lists),
